 ...
 * generated in the fr.doranco.jaxws.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetListeEtudiant_QNAME = new QName("http://jaxws.doranco.fr/", "getListeEtudiant");
    private final static QName _AddEtudiant_QNAME = new QName("http://jaxws.doranco.fr/", "addEtudiant");
    private final static QName _GetListeEtudiantResponse_QNAME = new QName("http://jaxws.doranco.fr/", "getListeEtudiantResponse");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: fr.doranco.jaxws.service
     * 
     */
    ...
    /**
     * Create an instance of {@link GetListeEtudiantResponse }
     * 
     */
    public GetListeEtudiantResponse createGetListeEtudiantResponse() {
        return new GetListeEtudiantResponse();
    }
    ...
    /**
     * Create an instance of {@link GetListeEtudiant }
     * 
     */
    public GetListeEtudiant createGetListeEtudiant() {
        return new GetListeEtudiant();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetListeEtudiant }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.doranco.fr/", name = "getListeEtudiant")
    public JAXBElement<GetListeEtudiant> createGetListeEtudiant(GetListeEtudiant value) {
        return new JAXBElement<GetListeEtudiant>(_GetListeEtudiant_QNAME, GetListeEtudiant.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetListeEtudiantResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.doranco.fr/", name = "getListeEtudiantResponse")
    public JAXBElement<GetListeEtudiantResponse> createGetListeEtudiantResponse(GetListeEtudiantResponse value) {
        return new JAXBElement<GetListeEtudiantResponse>(_GetListeEtudiantResponse_QNAME, GetListeEtudiantResponse.class, null, value);
    }
